...
urlpatterns = [
    ...
    url(r'^issues/(?P<issue_id>[0-9]+)/attachments/(?P<pk>[0-9]+)$', views.AttachmentDetail.as_view(),
    ...
    url(r'^issues/(?P<pk>[0-9]+)/watch/$', views.Watch.as_view(), name='watch'),
    url(r'^issues/(?P<pk>[0-9]+)/unwatch/$', views.UnWatch.as_view(), name='unwatch'),
    url(r'^user/watches/$', views.UserWatchesList.as_view(), name='user-watches-list'),
